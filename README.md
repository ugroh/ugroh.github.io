...
* In Ergänzung zu dem Beitrag DGoZ 02/2024 habe ich eine Übersicht zu den 30 Kategorien erstellt, die man in seinem Buch zu Tsume-Go findet (Kategorie.pdf). In dieser ist auch erklärt, wo man auf den IZIS Go-Board das »Buch« findet. Dies alles findet sich [unter diesem Link.](https://github.com/ugroh/ugroh.github.io/tree/main/Segoe-TsumeGo). In diesem Unterverzeichnis ist auch noch im SmartGo-, EPUB- bzw. PDF-Format eine Zusammenstellung der jeweils ersten zehn Probleme seiner Kategorien enthalten – momentan noch nicht vollständig (Segoe-TsumeGo_I.xyz).  
